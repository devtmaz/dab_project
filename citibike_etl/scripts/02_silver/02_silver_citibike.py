...
# code commented below would be needed if we want to run this script on Databricks Workspace directly.
# Importing packages from different directories requires adding the path to the packages to the sys.path.
# This is not needed when we run this script:
...
# # We do not need to include src directory in import path, as python wheel was configured
# # to include all packages from src/ directory
